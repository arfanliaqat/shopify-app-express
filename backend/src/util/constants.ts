...
export const helpScoutBeaconPrivateKey = process.env.HELP_SCOUT_BEACON_PRIVATE_KEY || ""
export const scopes = "read_products,write_orders,write_script_tags,write_themes"
...
export const DEBUG_LOG_ENABLED = process.env.DEBUG_LOG_ENABLED == "true"
